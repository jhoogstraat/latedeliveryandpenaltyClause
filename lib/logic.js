...
function execute(context) {
    ...
    if (context.request.machineFailure) {
        ...
        context.response.MaxEndededDeliveryTermination = calculateFuzzySystem(calculateFuzzySystem({ Defektschwere: malfunction, Schiffsgroesse: shipSize, Umschlagszahl: transhipmentFigures }))
    }
}
